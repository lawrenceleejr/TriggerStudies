...
#cmt_local_tagfile_check_install_python_modules = $(TrigHLTJetHemisphereRec_tag)_check_install_python_modules.make
...
#cmt_local_tagfile_check_install_python_modules = $(TrigHLTJetHemisphereRec_tag).make
...
#cmt_final_setup_check_install_python_modules = $(bin)TrigHLTJetHemisphereRec_check_install_python_modulessetup.make
...
#cmt_final_setup_check_install_python_modules = $(bin)TrigHLTJetHemisphereRecsetup.make
cmt_local_check_install_python_modules_makefile = $(bin)check_install_python_modules.make
...
$(check_install_python_modulesactionstamp) ::
	$(silent) /afs/cern.ch/atlas/software/builds/nightlies/devval/AtlasCore/rel_5/External/ExternalPolicy/cmt/atlas_check_installations.sh -files=' -s=../python *.py ' -installdir=/afs/cern.ch/work/l/leejr/NightlyTest/InstallArea/python/TrigHLTJetHemisphereRec -level=
