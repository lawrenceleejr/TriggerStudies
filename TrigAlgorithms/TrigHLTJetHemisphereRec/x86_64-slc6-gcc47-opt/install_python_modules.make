...
#
#   Generated Fri Nov 14 11:41:57 2014  by leejr
#
#====================================
...
#cmt_local_tagfile_install_python_modules = $(TrigHLTJetHemisphereRec_tag)_install_python_modules.make
...
#cmt_local_tagfile_install_python_modules = $(TrigHLTJetHemisphereRec_tag).make
...
#cmt_final_setup_install_python_modules = $(bin)TrigHLTJetHemisphereRec_install_python_modulessetup.make
...
#cmt_final_setup_install_python_modules = $(bin)TrigHLTJetHemisphereRecsetup.make
cmt_local_install_python_modules_makefile = $(bin)install_python_modules.make
...
install_dir = ${installarea}/python/TrigHLTJetHemisphereRec
...
TrigHLTJetHemisphereRecConfig_py_dependencies = ../python/TrigHLTJetHemisphereRecConfig.py


install_python_modulesinstall :: ${install_dir}/TrigHLTJetHemisphereRecConfig.py
	@if test ! "${installarea}" = ""; then\
	  echo "installation done"; \
	fi

${install_dir}/TrigHLTJetHemisphereRecConfig.py :: ../python/TrigHLTJetHemisphereRecConfig.py
	@if test ! "${installarea}" = ""; then \
	  d=`dirname ../python/TrigHLTJetHemisphereRecConfig.py`; \
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_install_action) "$${d}" "TrigHLTJetHemisphereRecConfig.py" "$(install_dir)" "ln -sf" "$($(package)_cmtpath)"; \
	fi

../python/TrigHLTJetHemisphereRecConfig.py : ;
...
install_python_modulesuninstall ::
	@if test ! "${installarea}" = ""; then \
	  ...
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_uninstall_action) "$${d}" "TrigHLTJetHemisphereRecConfig.py" "$(install_dir)" "$($(package)_cmtpath)"; \
	fi
