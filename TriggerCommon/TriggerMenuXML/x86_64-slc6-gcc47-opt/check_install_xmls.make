...
#
#   Generated Fri Nov 14 10:53:43 2014  by leejr
#
#====================================
...
#cmt_local_tagfile_check_install_xmls = $(TriggerMenuXML_tag)_check_install_xmls.make
...
#cmt_local_tagfile_check_install_xmls = $(TriggerMenuXML_tag).make
...
#cmt_final_setup_check_install_xmls = $(bin)TriggerMenuXML_check_install_xmlssetup.make
...
#cmt_final_setup_check_install_xmls = $(bin)TriggerMenuXMLsetup.make
cmt_local_check_install_xmls_makefile = $(bin)check_install_xmls.make
...
$(check_install_xmlsactionstamp) ::
	$(silent) /afs/cern.ch/atlas/software/builds/nightlies/devval/AtlasCore/rel_5/External/ExternalPolicy/cmt/atlas_check_installations.sh -files=' -s=../data *.dtd *.xml  ' -installdir=/afs/cern.ch/work/l/leejr/NightlyTest/InstallArea/XML/TriggerMenuXML -level=
