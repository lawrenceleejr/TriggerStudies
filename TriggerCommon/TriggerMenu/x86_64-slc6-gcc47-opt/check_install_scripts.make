...
#cmt_local_tagfile_check_install_scripts = $(TriggerMenu_tag)_check_install_scripts.make
...
#cmt_local_tagfile_check_install_scripts = $(TriggerMenu_tag).make
...
#cmt_final_setup_check_install_scripts = $(bin)TriggerMenu_check_install_scriptssetup.make
...
#cmt_final_setup_check_install_scripts = $(bin)TriggerMenusetup.make
cmt_local_check_install_scripts_makefile = $(bin)check_install_scripts.make
...
$(check_install_scriptsactionstamp) ::
	$(silent) /afs/cern.ch/atlas/software/builds/nightlies/devval/AtlasCore/rel_5/External/ExternalPolicy/cmt/atlas_check_installations.sh -files=' -s=../share -s=../scripts generate*Menu.py ' -installdir=/afs/cern.ch/work/l/leejr/NightlyTest/InstallArea/share/bin -level=
