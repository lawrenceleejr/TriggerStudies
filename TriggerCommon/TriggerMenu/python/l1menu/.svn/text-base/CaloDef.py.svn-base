...
class CaloDef:
    ...
    def defineGlobalSettings(tc, tag=None):
        ...
        caloInfo.isolation["EMIsoForEMthr"] .addIsolation( isobit=2, slope=0, offset=20 )\
                                            .addIsolation( isobit=3, slope=0, offset=20 )\
                                            .addIsolation( isobit=4, slope=80, offset=-18, mincut=10, upperlimit=50)
                                            
        caloInfo.isolation["HAIsoForEMthr"] .addIsolation( isobit=1, slope=0,   offset=10 )\
                                            .addIsolation( isobit=3, slope=0,   offset=10 )\
                                            .addIsolation( isobit=4, slope=230, offset=-2, mincut=10, upperlimit=50)\

        caloInfo.isolation["EMIsoForTAUthr"] .addIsolation( isobit=1, slope=192, offset=23, upperlimit=126 )\
	                                     .addIsolation( isobit=2, slope=192, offset=23, upperlimit=90 )\
	                                     .addIsolation( isobit=3, slope=0, offset=40)
