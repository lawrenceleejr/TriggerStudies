...
# MUON ctpid=[0x20;0x2f]
        ...
        LVL1MenuItem('L1_LUCID_COMM_EMPTY'  ).setLogic( NIMDIR5             & cosmiccond).setTriggerType(TT.minb)
        ...
        # TRT
        LVL1MenuItem('L1_TRT', ctpid=0x4e).setLogic(NIMDIR25 & BGRP0).setTriggerType(TT.rpcout)
        ...
        try:
            ...
            # W T&P
            LVL1MenuItem("L1_EM3_10MINDPHI-AJj15s2-XE0",ctpid=-1).setLogic( EM3 & TOPO_10MINDPHI_AJj15s2_XE0 & physcond)
            LVL1MenuItem("L1_EM3_20MINDPHI-AJjs6-XE0",ctpid=-1).setLogic( EM3 & TOPO_20MINDPHI_AJjs6_XE0 & physcond)
            LVL1MenuItem("L1_EM3_20MINDPHI-AJj15s2-XE0",ctpid=-1).setLogic( EM3 & TOPO_20MINDPHI_AJj15s2_XE0 & physcond)
            LVL1MenuItem("L1_EM3_10MINDPHI-EM6s1-XE0",ctpid=-1).setLogic( EM3 & TOPO_10MINDPHI_EM6s1_XE0 & physcond)
            LVL1MenuItem("L1_EM3_20MINDPHI-EM9s6-XE0",ctpid=-1).setLogic( EM3 & TOPO_20MINDPHI_EM9s6_XE0 & physcond)
            LVL1MenuItem("L1_EM3_20MINDPHI-EM6s1-XE0",ctpid=-1).setLogic( EM3 & TOPO_20MINDPHI_EM6s1_XE0 & physcond)
            LVL1MenuItem("L1_EM3_05RATIO-XE0-HT0-AJj15all.ETA49",ctpid=-1).setLogic( EM3 & TOPO_05RATIO_XE0_HT0_AJj15allETA49 & physcond)
            LVL1MenuItem("L1_EM3_08RATIO-XE0-HT0-AJj0all.ETA49",ctpid=-1).setLogic( EM3 & TOPO_08RATIO_XE0_HT0_AJj0allETA49 & physcond)
            LVL1MenuItem("L1_EM3_40RATIO2-XE0-HT0-AJj15all.ETA49",ctpid=-1).setLogic( EM3 & TOPO_40RATIO2_XE0_HT0_AJj15allETA49 & physcond)
            LVL1MenuItem("L1_EM3_90RATIO2-XE0-HT0-AJj0all.ETA49",ctpid=-1).setLogic( EM3 & TOPO_90RATIO2_XE0_HT0_AJj0allETA49 & physcond)
            LVL1MenuItem("L1_EM3_HT20-AJj0all.ETA49",ctpid=-1).setLogic( EM3 & TOPO_HT20_AJj0allETA49 & physcond)
            LVL1MenuItem("L1_EM3_NOT-02MATCH-EM9s1-AJj15all.ETA49",ctpid=-1).setLogic( EM3 & TOPO_NOT_02MATCH_EM9s1_AJj15allETA49 & physcond)
            LVL1MenuItem("L1_EM3_NOT-02MATCH-EM9s1-AJj15all.ETA49_05RATIO-XE0-SUM0-EM9s1-HT0-AJj15all.ETA49",ctpid=-1).setLogic( EM3 & TOPO_NOT_02MATCH_EM9s1_AJj15allETA49 & TOPO_05RATIO_XE0_SUM0_EM9s1_HT0_AJj15allETA49 & physcond)

            # Bphysics triggers
            LVL1MenuItem("L1_2DR15-2MU4ab",  ctpid=-1).setLogic( TOPO_2DR15_2MU4ab & physcond)            
            #LVL1MenuItem("L1_2INVM-2MU4ab",  ctpid=-1).setLogic( TOPO_2INVM_2MU4ab & physcond)            
