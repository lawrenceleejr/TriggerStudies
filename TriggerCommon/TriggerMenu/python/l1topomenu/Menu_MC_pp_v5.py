def defineMenu():
    ...
    Full_topomenu = [
        ...
        # HT                                                                
        TopoOutput( algoname='HT200-AJ20all.ETA49',                         module=0, fpga=1, clock=1, firstbit=3 ),
        TopoOutput( algoname='HT200-AJ20s5.ETA49',                          module=0, fpga=1, clock=1, firstbit=4 ),
        TopoOutput( algoname='HT190-AJ20all.ETA49',                         module=0, fpga=1, clock=1, firstbit=5 ),
