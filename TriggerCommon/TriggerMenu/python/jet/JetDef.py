...
def run_strawman_test(use_atlas_config=True, debug=True):
    ...
    from_central = [
        ...
        {'EBstep': 1, 'signatures': '', 'stream': ['Jet'], 'chainParts': [{'trigType': 'j', 'scan': 'FS', 'dataType': 'tc', 'multiplicity': '1', 'extra': '', 'etaRange': '0eta320', 'topo': [], 'calib': 'had', 'L1item': '', 'signature': 'Jet', 'threshold': '60', 'bTag': [], 'addInfo': [], 'chainPartName': 'j60', 'recoAlg': 'a4',  'dataScouting': 'ds1'}], 'topo': [], 'chainCounter': 103, 'groups': ['RATE:SingleJet', 'BW:Jets'], 'signature': 'Jet', 'L1item': 'L1_J20', 'chainName': 'j60'},

            {'EBstep': 1, 'signatures': '', 'stream': ['Jet'], 'chainParts': [{'trigType': 'j', 'scan': 'FS', 'dataType': 'tc', 'multiplicity': '1', 'extra': '', 'etaRange': '0eta320', 'topo': [], 'calib': 'had', 'L1item': '', 'signature': 'Jet', 'threshold': '60', 'bTag': [], 'addInfo': [], 'chainPartName': 'j60', 'recoAlg': 'a4', 'dataScouting': 'ds2'}], 'topo': [], 'chainCounter': 103, 'groups': ['RATE:SingleJet', 'BW:Jets'], 'signature': 'Jet', 'L1item': 'L1_J20', 'chainName': 'j60'},
]
    return [generateHLTChainDef(fc) for fc in from_central]
