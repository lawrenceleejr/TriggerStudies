...
def _make_jr(chain_config):
    ...
    jes_label = 'jes' if fex_params.do_jes else 'nojes'
    alias = 'antikt%s_tc_%s' % (str(fex_params.merge_param), jes_label)

    return AlgList([alg_dispatcher['jetrec'](menu_data)], alias)
