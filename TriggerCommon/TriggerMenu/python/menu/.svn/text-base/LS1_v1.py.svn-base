...
def setupMenu():
    ...
    TriggerFlags.StreamingSlice.signatures =  [
        ...
        ['noalg_dcmmon_L1RD0_EMPTY',        6666, 'L1_RD0_EMPTY',        [], ['monitoring_random'], [""], -1], 
        ...
        ['noalg_eb_L1RD0_UNPAIREDISO',        7003, 'L1_RD0_UNPAIRED_ISO',  [], ['EnhancedBias'], ["Supporting", "Calibration", "BW:Detector"], -1],
    ...
    TriggerFlags.EnhancedBiasSlice.signatures = [
        ...
        ['eb_L1RD0_FILLED',                   7010, 'L1_RD0_FILLED',         [], ['EnhancedBias'], ["Supporting", "Calibration", "BW:Detector"], -1],
