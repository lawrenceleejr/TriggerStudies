...
def setupMenu():
    ...
    TriggerFlags.MuonSlice.signatures = [ 
        ...
        ['mu0_muoncalib',939, 'L1_MU4',[],['Muon_Calibration'],["RATE:SingleMuon","BW:Muon"],-1],
    ...
    TriggerFlags.EgammaSlice.signatures = [
        ['e5_loose1',               946,          'L1_EM3', [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], -1],
        ['e5_lhloose',              947, 'L1_EM3', [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1],
        ...
        ['g0_perf_L1EM3',           954, 'L1_EM3', [], [PhysicsStream], ['RATE:SingleElectron', 'BW:Egamma'], 1],


        ]

    TriggerFlags.BphysicsSlice.signatures = [
        ['2mu4_bDimu',               955, 'L1_2MU4', [], [PhysicsStream], ['RATE:Bphysics_MultiMuon','BW:Bphys'], -1], 
        ['2mu4_bDimu_novtx_noos',    956, 'L1_2MU4', [], [PhysicsStream], ['RATE:Bphysics_MultiMuon','BW:Bphys'], -1],  
        ['2mu6_bDimu',               957, 'L1_2MU6', [], [PhysicsStream], ['RATE:Bphysics_MultiMuon','BW:Bphys'], -1], 
        ['2mu6_bDimu_novtx_noos',    958, 'L1_2MU6', [], [PhysicsStream], ['RATE:Bphysics_MultiMuon','BW:Bphys'], -1],  
    ...
    TriggerFlags.StreamingSlice.signatures = [
        ...
        ['noalg_dcmmon_L1RD0_EMPTY',        6548, 'L1_RD0_EMPTY',        [], ['monitoring_random'], [""], -1], 
        ...
        #HLT pass through
        ['noalg_L1All',                  6675, 'L1_All',              [], ['HLTPassthrough'], ["Supporting", "Calibration", "BW:Detector"], -1],
        ['noalg_L1J12',                  6676, 'L1_J12',              [], ['HLTPassthrough'], ["Supporting", "Calibration", "BW:Detector"], -1],
        ['noalg_L1TAU8',                 6677, 'L1_TAU8',             [], ['HLTPassthrough'], ["Supporting", "Calibration", "BW:Detector"], -1],
        ['noalg_L1EM3',                  6559, 'L1_EM3',             [],  ['HLTPassthrough'], ["Supporting", "Calibration", "BW:Detector"], -1],
        
        # jettauetmiss streamer
        ['noalg_jettauetmiss_L1RD0_FIRSTEMPTY',   6678, 'L1_RD0_FIRSTEMPTY',  [], ['JetTauEtmiss'], ["Supporting", "Calibration", "BW:Detector"], -1],
