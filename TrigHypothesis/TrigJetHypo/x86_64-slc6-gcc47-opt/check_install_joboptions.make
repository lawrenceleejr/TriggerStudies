...
#cmt_local_tagfile_check_install_joboptions = $(TrigJetHypo_tag)_check_install_joboptions.make
...
#cmt_local_tagfile_check_install_joboptions = $(TrigJetHypo_tag).make
...
#cmt_final_setup_check_install_joboptions = $(bin)TrigJetHypo_check_install_joboptionssetup.make
...
#cmt_final_setup_check_install_joboptions = $(bin)TrigJetHyposetup.make
cmt_local_check_install_joboptions_makefile = $(bin)check_install_joboptions.make
...
$(check_install_joboptionsactionstamp) ::
	$(silent) /afs/cern.ch/atlas/software/builds/nightlies/devval/AtlasCore/rel_5/External/ExternalPolicy/cmt/atlas_check_installations.sh -files=' -s=../share jobOfragment_*.py TriggerConfig_*.py ' -installdir=/afs/cern.ch/work/l/leejr/NightlyTest/InstallArea/jobOptions/TrigJetHypo -level=
